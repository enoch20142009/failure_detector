...
# Arch C multi-seed (seed 2024). Sequential depth-recurrent refinement, identical
# to 19_ngf_v2c_sequential.sh but seed=2024, to estimate run-to-run variance
# (combine with the seed=42 and seed=123 runs).
#
