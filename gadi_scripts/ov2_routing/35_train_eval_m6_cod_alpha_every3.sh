...
#PBS -j oe
#
# M6 COD-α every-3 depths: 3,6,9,12,15,18,21 + base.
#   qsub gadi_scripts/ov2_routing/35_train_eval_m6_cod_alpha_every3.sh
#
set -euo pipefail
module purge
...
RESULT_DIR=./results_ov2_calvin_m6_cod_alpha_every3
EVAL_IN=./eval_results/ov2_calvin_m6_cod_alpha_every3_indomain
EVAL_X=./eval_results/ov2_calvin_m6_cod_alpha_every3_to_droid
...
python src/finetune_FS_ov2_routed.py \
  ...
  --vision_layer_indices 3 6 9 12 15 18 21 \
...
echo "Done M6 every3: ${RESULT_DIR}"
