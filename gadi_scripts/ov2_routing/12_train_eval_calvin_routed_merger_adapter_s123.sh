...
#PBS -j oe
#
# M0 champion multi-seed (seed 123). Same as job 12; combine with seed=42 for variance.
#
...
RESULT_DIR=./results_ov2_calvin_routed_merger_adapter_s${SEED}
EVAL_IN=./eval_results/ov2_calvin_routed_merger_adapter_s${SEED}_indomain
EVAL_X=./eval_results/ov2_calvin_routed_merger_adapter_s${SEED}_to_droid

echo "==== M0 champion seed ${SEED}: routed + merger adapter on CALVIN-1p ===="
