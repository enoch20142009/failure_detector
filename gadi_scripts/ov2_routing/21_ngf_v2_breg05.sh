...
# beta-regularized NGF-0 (L2=0.05, stronger). Brackets 21_ngf_v2_breg01.sh to
# map how hard the inner residual must be shrunk before transfer recovers toward
# the inner-OFF (A2) baseline. At large L2 this should approach A2 behavior.
...
RESULT_DIR=./results_ov2_calvin_ngf_v2_breg05
EVAL_IN=./eval_results/ov2_calvin_ngf_v2_breg05_indomain
EVAL_X=./eval_results/ov2_calvin_ngf_v2_breg05_to_droid
