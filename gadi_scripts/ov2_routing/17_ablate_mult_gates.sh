...
# A6 — NGF ablation: full NGF but multiplicative gates (instead of guiding).
# Tests whether guiding is necessary in a deep nested stack (expect job-14-like
# instability risk with multiplicative gates).
#
...
RESULT_DIR=./results_ov2_calvin_ngf_a6_mult_v2
EVAL_IN=./eval_results/ov2_calvin_ngf_a6_mult_v2_indomain
EVAL_X=./eval_results/ov2_calvin_ngf_a6_mult_v2_to_droid

echo "==== A6 train: NGF full, multiplicative gates on CALVIN-1p ===="
